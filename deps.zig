...
pub const dirs = struct {
    pub const _root = "";
    pub const _rrkchkhsofmy = cache ++ "/../..";
    pub const _n38mz4rz4uev = cache ++ "/git/github.com/frmdstryr/zig-datetime";
};

pub const package_data = struct {
    pub const _rrkchkhsofmy = Package{
        .directory = dirs._rrkchkhsofmy,
    };
    pub const _n38mz4rz4uev = Package{
        .directory = dirs._n38mz4rz4uev,
        .pkg = Pkg{ .name = "datetime", .source = .{ .path = dirs._n38mz4rz4uev ++ "/src/main.zig" }, .dependencies = null },
    };
...
pub const packages = &[_]Package{
    package_data._n38mz4rz4uev,
};

pub const pkgs = struct {
    pub const datetime = package_data._n38mz4rz4uev;
};
